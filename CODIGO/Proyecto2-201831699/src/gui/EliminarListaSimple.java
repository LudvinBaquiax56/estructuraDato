 ...
 * @author baquiax
 */
public class EliminarListaSimple extends JFrame {

    ListaSimple lista;
    VentanaListaSimple ventana;

    JTextField txtValor;
    JButton btnAgregar;
    JLabel lblValor;

    public EliminarListaSimple(VentanaListaSimple ventana, ListaSimple lista) throws HeadlessException {
    ...
    private void eliminar(ActionEvent e) {
        if (!txtValor.getText().isEmpty()) {
            try {
                lista.eliminarElementoEspecifico(Integer.parseInt(txtValor.getText()));
